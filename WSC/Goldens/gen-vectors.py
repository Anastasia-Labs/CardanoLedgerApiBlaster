...
# Provenance banner emitted at the TOP of every generated file.
#
# Task N1 hand-added a "PRE-#112 SUPERSEDED" warning line to Vectors.lean,
# Terms.lean and TermsCheck.lean.  That was correct at the time but broke
# `--check` (these files are GENERATED, so any hand edit makes committed !=
# generated).  The banner is therefore emitted BY THE GENERATOR from here on:
# it stays accurate, it survives regeneration, and `--check` stays green.
PROVENANCE_BANNER = (
    "-- \u2705 POST-#112: regenerated by task N2 from wsc-poc main @ 2306678 "
    "(PR #112).\n"
    "-- These vectors are CURRENT.  Do not re-add a PRE-#112 warning by hand: "
    "this file is\n"
    "-- generated by WSC/Goldens/gen-vectors.py and a hand edit breaks its "
    "--check gate.\n"
    "-- Context for what #112 changed: WSC/goldens/MANIFEST.md and "
    "WSC/IMPACT-PR112.md.\n"
)
