...
| **P2b, GENERALIZED (task R3)** | PROVED over MULTI-TOKEN-NAME values — removes the "one token name" caveat | `P2b_R2_containment` (`P2ShapedR2.lean`) | 3800 / **S1R2** | **2739** (accept) / 2738 | `ctxResidual2_realizable` | **4/4** |
