...
/-
WSC/Shaped/GlobalShapedP1RMintPrep.lean — the SHAPED `#prep_uplc` of the production
transfer validator over the NODE-REALIZABLE re-cut **SHAPE T2R (P1 with nonzero symbolic mint)**
...
#prep_uplc appliedGlobalShapedT2R programmableLogicGlobal1600 p1RShapedMintInputs 4400
